...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.0.7/CodeAgentRuntime.xcframework.zip",
            checksum: "6536287e57c13d4a62f86195a628de87d2582ee7d5b8ba46831dccf83555f019"
        ),
