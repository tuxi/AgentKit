...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.0.9/CodeAgentRuntime.xcframework.zip",
            checksum: "eccf3ea829435815eb73e08d2351c8c0d75b098b17b903e6a3626ae0e20c0444"
        ),
