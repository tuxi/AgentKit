...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.2.9/CodeAgentRuntime.xcframework.zip",
            checksum: "deeb42d685eb9631f27451cddc47420ce8a7b6e42d947911a94620775319885d"
        ),
