...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.3.2/CodeAgentRuntime.xcframework.zip",
            checksum: "d550ca5009e96f644a77702715ce836a47944f3d3d25ad4eeef853e57629732f"
        ),
