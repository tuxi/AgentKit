...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.4.6/CodeAgentRuntime.xcframework.zip",
            checksum: "c0ddecff2c13ddf1a3e35dbece1d2706b34139ffac5dca887f409fb772ca41b9"
        ),
