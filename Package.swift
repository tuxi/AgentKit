...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.2.5/CodeAgentRuntime.xcframework.zip",
            checksum: "e397cd60ce6014fb895d60d171256c5212e15aa836679e93d6a36395c8be1b8c"
        ),
