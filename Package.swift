...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.3.1/CodeAgentRuntime.xcframework.zip",
            checksum: "f39906e8f7c62b9fcc9f933936a36347ff69000117db71ee5b8d8e06635dd393"
        ),
