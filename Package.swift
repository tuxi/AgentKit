...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.0.6/CodeAgentRuntime.xcframework.zip",
            checksum: "ad090513134ce215769cda987acff4629b2cb6ab1551c4096ac11a1aea247617"
        ),
