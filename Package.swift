...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.6.2/CodeAgentRuntime.xcframework.zip",
            checksum: "f3453f5ec97d6158c760982b2237b1ad7c2e2556056929006642e28daa0f15fa"
        ),
