...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/0.9.1/CodeAgentRuntime.xcframework.zip",
            checksum: "fc7246acaa2b8bcf7270ad450f168fd56abe845bf81267b18605da2fea1db084"
        ),
