...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.6.1/CodeAgentRuntime.xcframework.zip",
            checksum: "c578198994b34aacf3c85a5672895ca66d1ef762ffbf292fd96b3d7676a186bb"
        ),
