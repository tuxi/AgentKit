...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.0.4/CodeAgentRuntime.xcframework.zip",
            checksum: "ec7622653d4282dc1aa855eb7e15acf9a64dfc655d670cf6e1f5caf7135d674d"
        ),
