...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.2.6/CodeAgentRuntime.xcframework.zip",
            checksum: "2949f4c1ad12e85f52b8df6a8438e1357893514426f27d06a0496e7806081bb7"
        ),
