...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/tuxi/code-agent-releases/releases/download/1.2.2/CodeAgentRuntime.xcframework.zip",
            checksum: "e8d492fb618ee0f615a35871728d35a7d4e9bded87d8a4c54fc762219be523ae"
        ),
